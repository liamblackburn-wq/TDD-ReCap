...
* **Browser Automation (E2E):** Python Playwright
...
| :--- |:-------|:------------|
| **Integration Tests** | 62     | 63.92%      |
| **End-to-End (E2E) Tests** | 8      | 8.25%       |
| **Unit Tests** | 27     | 27.84%      |
| **Total** | **97** | **100.00%** |
...
* **Execute coverage capture and coverage report:**
    ```bash
    coverage run -m pytest -s tests
    coverage report
    ```
**Currently, coverage is sitting at a very healthy 96%**